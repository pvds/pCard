    ...
    if($contacts_raw){
        foreach ($contacts_raw as $contact_id => $contact){
           ...
           <li $data_contact_id $data_fav>
            <img src='avatars/$image.jpg' width='64' height='64' srcset='avatars/$image.jpg 2x'/>
...
function getContactDetails(){
    ...
    if($contact){
        ...
        if(!empty($contact['image'])){
            $contact['image-html'] = "
            <img id='contact-details-image' src='avatars/$image.jpg' width='64' height='64' alt='' srcset='avatars/$image.jpg 2x'/>
