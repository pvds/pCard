<div id="contact-details-actions" class="menu-list has-stacked-icons">
    <ul>
        <li>
            <a href="tel:<?=$contact['phone']['private']?>" id="contact-details-actions-call" class="button">
        ...
        <li>
            <a href="mailto:<?=$contact['mail']['private']?>" id="contact-details-actions-mail" class="button">
