<div id="contact-actions" class="menu has-stacked-icons">
    <ul>
        ...
        <li>
            <a href="mailto:<?=$contact['mail']['action']?>" <?=$contact['mail']['status']?> id="contact-actions-mail" class="button">
        ...
        <li>
            <button id="contact-actions-edit">
        ...
        <li class="is-hidden">
            <button id="contact-actions-delete">
        ...
        <li class="is-hidden">
            <button id="contact-actions-favorite">
        ...
        <li class="is-hidden">
            <button id="contact-actions-save">
